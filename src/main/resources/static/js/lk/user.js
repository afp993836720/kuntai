...
function submit_deposit() {
	...
	var posturl = "/index/user/addplay1";
	var gourl = '/index/user/mcpay.html?price='+bpprice;
	location.href = gourl;
	can_balance(1);
	...
	$.post(posturl,postdata,function(res){
		...
		if(res.type == -1){
          ...
          if(pay_type.indexOf( 'codepay')>-1) {

            var gourl = '/index/user/codepay.html?id=' + res.bpid;
            location.href = gourl;
            can_balance(1);
          }else{
